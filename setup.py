...
setup(name="pyLabDataLogger",
      ...
      packages=['pyLabDataLogger','pyLabDataLogger.logger','pyLabDataLogger.device','pyLabDataLogger.device.i2c','pyLabDataLogger.device.ut61eplus','pyLabDataLogger.mcclibusb'],
